...
OhdsiRTools::checkUsagePackage("breastCancer")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/breastCancer.pdf")
shell("R CMD Rd2pdf ./ --output=extras/breastCancer.pdf")
...
OhdsiRTools::createRenvLockFile(rootPackage = "breastCancer",
                                mode = "description",
